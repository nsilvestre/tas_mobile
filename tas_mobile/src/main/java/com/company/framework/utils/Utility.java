...
public class Utility
{
    ...
    public static void captureScreenshot(WebDriver driver, Scenario scenario)
    {
        ...
        try
        {
            ...
            //Screenshot in Reportportal - Can be implemented like this or using embedScreenshot method.
            //On this last case comment the following call: ReportPortal.emitLog().
            ReportPortal.emitLog("***** Test of message with screenshot *****",
                                 "INFO",
